...
4. **하나를 떠올리면 관련된 것도 따라온다** → "축구" 하면 "수원삼성" "태민이" "직관"
...
// 2. 기억 저장
await mem.store('문정님은 수원삼성 시즌권을 가지고 있다', {
  category: 'fact',
  tags: ['수원삼성', '축구']
});

await mem.store('아들 태민이랑 홈경기 직관 간다', {
  category: 'fact',
  tags: ['태민', '수원삼성', '축구']
});
...
// → [
//   { content: '수원삼성 시즌권 보유', score: 0.95 },
//   { content: '태민이랑 홈경기 직관', score: 0.82 }
// ]
...
<p align="center">
  ...
  <sub>Built with ❤️ by <a href="https://github.com/reallygood83">문정</a></sub>
</p>
